...
KG_EXTRACTOR_DIR = r"C:\backup folder\backend\data\all_extracted_kg.json"
...
if __name__ == "__main__":
    kg_file = r"C:\backup folder\backend\data\all_extracted_kg.json" # Make sure this file is in the same directory as this script
